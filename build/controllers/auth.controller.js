...
var jwt_1 = require("@overnightjs/jwt");
var core_1 = require("@overnightjs/core");
var jwtMgr = new jwt_1.JwtManager('mysecretKey', '10h');
var jwtController = /** @class */ (function () {
    function jwtController() {
    }
    jwtController.prototype.getJwtFromHandler = function (req, res) {
        var jwtStr = jwtMgr.jwt({
    ...
    jwtController.prototype.callProtectedRouteFromHandler = function (req, res) {
        return res.status(http_status_codes_1.OK).json({
